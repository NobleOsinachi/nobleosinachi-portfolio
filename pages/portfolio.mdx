...
- Description: Worked with a brownfield Wordpress child theme called Praisegeek MPT. Aims to create a highly customizable website with hard-coded pages for greater control and functionality.
- **Skills**: WordPress, Bulma CSS, jQuery, HTML5
...
## Lakeview Library Management System (2020)

![Lakeview Library Management System](/images/library.png)

- Description: I designed a library portal for a fictional library, Lakeview. It features asset management, patron profiling, asset checkout, hold placement on overdue assets.
<!-- https://www.youtube.com/watch?v=WTVcLFTgDqs -->
- **Skills**: ASP.NET Core, C#, Microsoft SQL Server, Entity Framework Core, LINQ
- [View on GitHub ↗](https://github.com/NobleOsinachi/Library.git/)
